  ...
  return (
    <center>
      <div className="surveyContainer mt-5 column is-6">
        ...
        <input className="input is-info is-small column is-6" type="text" placeholder="occupation" value={occupation} onChange={(e) => setoccupation(e.target.value)}/>
        <button className="btn btn-primary mt-4 mb-4 w-100" id="btnsubmit" onClick={editCustomer}>Submit</button>
      </div>
    </center>
  )
}
