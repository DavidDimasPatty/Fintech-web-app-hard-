      ...
      <MDBContainer>
        <MDBCard className="mt-5 column is-6">
          <MDBCol>
            ...
            <MDBRow>
              <MDBCol>Date of Birth</MDBCol>
            </MDBRow>
            <MDBRow>
              <MDBCol><input className="input is-info is-small" type="date" maxDate={Date.now()} placeholder="username" value={birth} onChange={(e) => setbirth(e.target.value)}/></MDBCol>
            </MDBRow>
            <MDBRow>
              <MDBCol>Passport Number</MDBCol>
            </MDBRow>
            <MDBRow>
              <MDBCol><input className="input is-info is-small column is-6" type="text" placeholder="Passport Number" value={passportnum} onChange={(e) => setpassportnum(e.target.value)}/></MDBCol>
            </MDBRow>
            <MDBRow>
              <MDBCol><p>Nationality Country of Residence</p></MDBCol>
            </MDBRow>
            <MDBRow>
              <MDBCol><select class="select is-info" type="select" value={region} onChange={(e) => setregion(e.target.value)}>
          ...
          <MDBRow>
            <MDBCol><p>Phone Number</p></MDBCol>
          </MDBRow>
          <MDBRow>
            <MDBCol><input className="input is-info is-small column is-6" type="tel" placeholder="password" value={phone} onChange={(e) => setphone(e.target.value)}/></MDBCol>
          </MDBRow>
          <MDBRow>
            <MDBCol><p>Address</p></MDBCol>
          </MDBRow>
          <MDBRow>
            <MDBCol><input className="input is-info is-small column is-6" type="text" value={address} onChange={(e) => setaddress(e.target.value)}/>
          </MDBCol>
          </MDBRow>
          <MDBRow>
            <MDBCol><p>Occupation</p></MDBCol>
          </MDBRow>
          <MDBRow>
            <MDBCol><input className="input is-info is-small column is-6" type="text" value={occupation} onChange={(e) => setoccupation(e.target.value)}/></MDBCol>
          </MDBRow>
          <MDBRow className="mt-2 pb-4">
            <MDBCol><Button color="info" onClick={editCustomer}>Submit</Button></MDBCol>
          </MDBRow>
          </MDBCol>
        </MDBCard>
      </MDBContainer>
